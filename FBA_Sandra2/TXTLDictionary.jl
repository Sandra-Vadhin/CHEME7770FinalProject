function TXTLDictionary(time_start,time_stop,time_step)
  ...
  mRNA_length_1 = 969;
  protein_length_1 = 322;
  mRNA_length_2 = 888;
  protein_length_2 = 296;
  mRNA_length_3 = 2038;
  protein_length_3 = 679;

  #TXTL Parameters
  gene_copies = 3.125e10;
  mRNA_degradation_rate = 5.2;    #h^-1
  polysome_gain = 10;
  volume = 15e-6
  inducer = 35;
  ...
  protein_degradation_rate = -log(0.5)/protein_half_life;     #h^-1
  ...
  TXTL_dictionary["mRNA_length_1"] = mRNA_length_1
  TXTL_dictionary["protein_length_1"] = protein_length_1
  TXTL_dictionary["mRNA_length_2"] = mRNA_length_2
  TXTL_dictionary["protein_length_2"] = protein_length_2
  TXTL_dictionary["mRNA_length_3"] = mRNA_length_3
  TXTL_dictionary["protein_length_3"] = protein_length_3
  ...
  TXTL_dictionary["protein_degradation_rate"] = protein_degradation_rate
